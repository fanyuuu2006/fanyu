    ...
    <section className="h-screen">
      <div className="container h-full flex flex-col items-center justify-center gap-6">
        <div className="w-full flex justify-between items-end">
          ...
          <Link href="/#aboutMe">
            <div className="size-32 md:size-48 lg:size-64 shrink-0 rounded-full overflow-hidden border-2 border-(--primary) hover:drop-shadow-[0_0_1rem_var(--primary)] transition-all duration-300">
              <Image
