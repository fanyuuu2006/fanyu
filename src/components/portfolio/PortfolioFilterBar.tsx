...
type PortfolioFilterBarProps = React.HTMLAttributes<HTMLDivElement> & {
  tags: Set<string>;
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-4 items-center">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              aria-label={
                sortOrder === "newest" ? "目前：最新優先" : "目前：最舊優先"
              }
              title={
                sortOrder === "newest" ? "目前：最新優先" : "目前：最舊優先"
              }
            >
              <ArrowUpOutlined
                ...
                className={cn("transition-transform duration-300", {
                  "rotate-180": sortOrder === "oldest",
                })}
              />
              <span>{sortOrder === "newest" ? "最新" : "最舊"}</span>
            </button>
            ...
            >
              ...
              <span>篩選</span>
              {hasActive && (
                <span className="ml-0.5 text-xs opacity-75">({tags.size})</span>
              )}
            </button>
